...
| 2024-06-28 |  v1.3   | Wrote priority_list.py and restock.py and the code for their tests |
| 2024-07-1 |  v1.4   | The heap structure was rewritten and the heapq library was no longer used |
| 2024-07-1 |  v2.0   | Write UI, you can in the UI interface, display inventory, add item, and modify item inventory |
...
| 2024-07-4 |  v2.8   | Optimized test coverage |
